...
def load_image(file_path=None):
    ...
    if file_path:
        ...
        for i in range(200, 600, 100):
            pca_4096.append(convert_labe_to_text(classify_pca_extract(img, 4096, i)))
        ...
        pca_1024 = []
        for i in range(200, 600, 100):
            pca_1024.append(convert_labe_to_text(classify_pca_extract(img, 1024, i)))
...
app = TkinterDnD.Tk()
app.title("HAND_SIGN CLASSIFICTION")
app.geometry("500x800")
app.configure(bg="#12377F")

# Title
title = tk.Label(app, text="HAND_SIGN CLASSIFICTION", font=("Helvetica", 24), bg="#12377F", fg="white")
